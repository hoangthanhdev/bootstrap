...
<ol class="breadcrumb" id="xem">
    ...
    <li class="breadcrumb-item"><a href="/tag/<?php echo $row_breadcrumb['slug'];?>" target="_plank"><?php echo $row_breadcrumb['name'];?></a><i class="fa fa-angle-double-right mx-2" aria-hidden="true"></i></li>
