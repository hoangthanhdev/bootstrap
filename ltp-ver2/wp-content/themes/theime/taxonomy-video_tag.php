	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8 main-content">
                ...
                <?php else:?>
                	<div class="alert alert-info"><?php _e('Mục này hiện chưa được cập nhật phim. Bạn vui lòng quay lại sau hoặc quay lại trang chủ tại link => <a href="http://www.hataphim.com" title="www.hataphim.com">www.hataphim.com</a>','mars')?></div>
                <?php endif;?>
			</div>
			<?php get_sidebar();?>
		</div><!-- /.row -->
