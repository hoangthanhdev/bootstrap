...
class Mars_Subscribox_Widget_Class extends WP_Widget{
	...
	function widget($args, $instance){
        ...
        <?php endif;?>
        <?php if(isset(  $settings['soundcloud_active'] ) ):?>
	        <div class="social-counter-item">
	            <a target="_blank" href="<?php print ( isset( $videotube['soundcloud'] ) ? $videotube['soundcloud'] : '#' );?>">
	                <i class="fa fa-soundcloud"></i>
	                <span class="counter"><?php if( function_exists('mars_get_socials_count') ): print mars_get_socials_count('soundcloud'); endif; ?></span>
	                <span class="counter-text"><?php _e('Followers','mars');?></span>
	            </a>
	        </div>
        <?php endif;?>
        <?php if(isset(  $settings['youtube_active'] ) ):?>
	        <div class="social-counter-item">
	            <a target="_blank" href="<?php print ( isset( $videotube['youtube'] ) ? $videotube['youtube'] : '#' );?>">
	                <i class="fa fa-youtube"></i>
	                <span class="counter"><?php if( function_exists('mars_get_socials_count') ): print mars_get_socials_count('youtube'); endif; ?></span>
