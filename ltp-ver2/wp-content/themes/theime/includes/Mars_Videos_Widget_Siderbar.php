	...
	function widget($args, $instance){
		...
		?>
            ...
            <div class="right-sidebar">
	            <div class="col-sm-4 item responsive-height <?php print $this->id; ?>-<?php print get_the_ID();?>">
	            	<div class="item-img">
	            	<?php 
           ...
           <div class="right-content-sidebar">
	                <span class="title-sidebar"><a title="<?php the_title()?>" href="<?php the_permalink();?>"><?php the_title()?></a></span>
