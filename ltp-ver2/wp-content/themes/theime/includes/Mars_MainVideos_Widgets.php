			...
			<?php if( $widget_column == 3 ):?>
          	...
          	<?php endif;?>
                ...
                <?php elseif ( $widget_column ==2 ):?>
	          	...
	          	<?php endif;?>
	          			<?php if( !empty( $title ) ):?>
                        	<span class="title-section"><?php if( $icon != 'none'):?><i class="fa <?php print $icon;?>"></i><?php endif;?> <?php print $title;?></span>
                        <?php endif;?>
			                     ...
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wp_query->have_posts() ) : 
				                       	...
				                       	<?php if( $i == 1 ):?>
				                       		<div class="item active">
				                       	<?php endif;?>	
				                       		<div id="video-featured-<?php print $this->id; ?>-<?php the_ID();?>" class="col-sm-<?php print $class_columns;?> col-xs-6 item responsive-height video-<?php print get_the_ID();?>">
				                                <div class="item-img">
													<?php 
														if(has_post_thumbnail()){
	                                            ...
	                                            <span class="title-loop-videos"><a title="<?php the_title();?>" href="<?php the_permalink();?>"><?php the_title();?></a></span>
		                                     </div> 
					                    <?php
