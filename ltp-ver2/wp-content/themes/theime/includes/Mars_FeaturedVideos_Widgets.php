		...
		?>
		    <div id="carousel-featured-<?php print $this->id; ?>" class="carousel carousel-<?php print $this->id; ?> slide" data-ride="carousel">
		        <div class="container section-header">
		        	<?php if( $title ): ?>
		            <span class="title-section"><i class="fa fa-star"></i> <?php print $title;?></span>
		            <?php endif;?>
		                       	...
		                       	if( $wp_query->have_posts() ) : 
			                       	...
			                       	<?php endif;?>	
                                          ...
                                          <div class="feat-item">
                                                ...
                                                <span class="title-video-top"><a title="<?php the_title();?>" href="<?php the_permalink();?>"><?php the_title();?></a></span>
			                                </div> 
