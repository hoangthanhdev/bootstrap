...
Fixed: Broken layout when display full length.
Fixed: New theme options api, fully compatible with Redux Framework plugin.
Remove: Theme Options: Site icon, Google Analytics ... and a few unused fields.
...
Updated: videotube/languages/default.po
Updated: TGM-Plugin-Activation 2.5.2 (videotube/includes/class-tgm-plugin-activation.php)
...
Fixed: Video upload file at frontend.

New: Added video responsive supported (require jetpack plugin installed).

01/07/2015 V 1.3.4.1 Updated:
